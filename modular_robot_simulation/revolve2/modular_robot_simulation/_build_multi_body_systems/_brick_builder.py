...
from revolve2.modular_robot.revolve2.modular_robot.body.base import Brick
from revolve2.simulation.revolve2.simulation.scene import AABB, MultiBodySystem, Pose, RigidBody
